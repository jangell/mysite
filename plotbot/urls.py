...
urlpatterns = [
    ...
    url(r'^save_plot$', views.save_plot, name='save_plot'),					# ajax post to store the content of a plot
    url(r'^share/(?P<hash>.*)$', views.share, name='share'),				# load a simple page containing a shared plot
